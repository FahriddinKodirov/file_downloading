import 'package:file_downloading/screen/isolate_ui/file_date_screen/file_date_screen.dart';
...
class LocalNotificationService {
  ...
  void init(GlobalKey<NavigatorState> navigatorKey) {
    ...
    const AndroidInitializationSettings androidInitializationSettings =
        AndroidInitializationSettings("download1");
    ...
    flutterLocalNotificationsPlugin.show(
      ...
      NotificationDetails(
        android: AndroidNotificationDetails(
          ...
          icon: "download1",
          showProgress: true,
          largeIcon: const DrawableResourceAndroidBitmap('download1'),
        ),
      ),
